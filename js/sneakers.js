...
thumbnails.forEach(thumbnail => {
    thumbnail.addEventListener('click', event=>{
        ...
        imageContainer.style.backgroundImage = `url('img/hola/image-product-${event.target.id}.jpg')`
    });
});
...
modalthumbnails.forEach(modalthumbnail => {
    modalthumbnail.addEventListener('click', event=>{
        ...
        modalImageContainer.style.backgroundImage = `url('img/hola/image-product-${event.target.id.slice(-1)}.jpg')`
    });
});
...
function drawProductInModal(){
    productContainer.innerHTML = `
        <div class="cart-modal__details-container">
            <img class="cart-modal__image" src="img/hola/image-product-1-thumbnail.jpg" alt="">
            <div>
            <p class="cart-modal__product">Autumn Limited Edition...</p>
            <p class="cart-modal__price">$125 x3 <span>$375.00</span> </p>
            </div>
            <img class="cart-modal__delete" src="img/hola/icon-delete.svg" alt="delete">
        </div>
...
function changeNextImage(imgContainer){
    ...
    imgContainer.style.backgroundImage = `url('img/hola/image-product-${imgIndex}.jpg')`
}
